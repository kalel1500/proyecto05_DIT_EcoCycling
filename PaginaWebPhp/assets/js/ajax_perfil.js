...
function iniciarVariables_camposPerfil() {
	check_pass = document.getElementById('inp_reset_pass');
	pass = document.getElementById('group_new_pas');
...
function ajax_fotos(){
	...
	$.ajax({
		method: "POST",
		url: "assets/php/fotosPerfil.proc.php",
		cache: false,
...
function ajax_modificarUsuario(){
	...
	$.ajax({
		method: "POST",
		url: "assets/php/modificar_perfil.proc.php",
