						...
						<div class="col-sm-6 col-md-6">
							<div class="thumbnail">
										...
										<div class="caption text-center" style="padding-bottom: 5px;">
											...
											Donar: <input form="form-<?=$photo?>" type="text" name="donation" id="donation" size="4" <?php if(!($pay)) {echo "disabled";} ?> /> ECOPoints<br><br><br><br>
											<p><button type="submit" href="#" form="form-<?=$photo?>" class="btn btn-success" role="button">Realizar donación</button></p>
										</div>
