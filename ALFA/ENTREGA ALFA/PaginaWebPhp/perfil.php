			...
			<div class="col-md-12 info-container">
				<form class="form-horizontal col-sm-5 center-block" name="form_mod_perfil" id="id-form-perfil">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control perfil" type="text" id="inp_usuario" name="inp_usuario">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control perfil" type="text" id="inp_nombre" name="inp_nombre">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control perfil" type="text" id="inp_apellido" name="inp_apellido">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input class="form-control perfil" type="text" id="inp_correo" name="inp_correo">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<label class="radio-inline">
									<input class="perfil" type="radio" name="inp_sexo" id="inp1_sexo" value="Hombre"> Hombre
								</label>
								<label class="radio-inline">
									<input class="perfil" type="radio" name="inp_sexo" id="inp2_sexo" value="Mujer"> Mujer
								</label>
								<label class="radio-inline">
									<input class="perfil" type="radio" name="inp_sexo" id="inp3_sexo" value="Otros"> Otros
								</label>
						...
						<div class="form-group" style="display: none;" id="group_new_pas">
							...
							<div class="col-sm-8">
								<input class="form-control perfil" type="password" id="inp_new_pas" name="inp_new_pas">
						...
						<div class="form-group" style="display: none;" id="group_conf_new_pas">
							...
							<div class="col-sm-8">
								<input class="form-control perfil" type="password" id="inp_conf_new_pas" name="inp_conf_new_pas">
							</div>
						</div>
