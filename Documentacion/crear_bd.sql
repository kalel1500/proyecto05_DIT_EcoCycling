...
('assets/img/users/',	'1_foto01',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel00")),
('assets/img/users/',	'2_foto02',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel00")),
('assets/img/users/',	'3_foto03',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel00")),
('assets/img/users/',	'4_foto04',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel01")),
('assets/img/users/',	'5_foto05',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel01")),
('assets/img/users/',	'6_foto06',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel01")),
('assets/img/users/',	'7_foto07',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel02")),
('assets/img/users/',	'8_foto08',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel02")),
('assets/img/users/',	'9_foto09',		'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel02")),
('assets/img/users/',	'10_foto10',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel03")),
('assets/img/users/',	'11_foto11',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel03")),
('assets/img/users/',	'12_foto12',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel03")),
('assets/img/users/',	'13_foto13',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel04")),
('assets/img/users/',	'14_foto14',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel04")),
('assets/img/users/',	'15_foto15',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel04")),
('assets/img/users/',	'16_foto16',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel05")),
('assets/img/users/',	'17_foto17',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel05")),
('assets/img/users/',	'18_foto18',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel05")),
('assets/img/users/',	'19_foto19',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel06")),
('assets/img/users/',	'20_foto20',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel06")),
('assets/img/users/',	'21_foto21',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel06")),
('assets/img/users/',	'22_foto22',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel07")),
('assets/img/users/',	'23_foto23',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel07")),
('assets/img/users/',	'24_foto24',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel07")),
('assets/img/users/',	'25_foto25',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel08")),
('assets/img/users/',	'26_foto26',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel08")),
('assets/img/users/',	'27_foto27',	'.jpg',	(SELECT `nivel_id` FROM `tbl_nivel` WHERE `nivel_nombre` = "nivel08"));
